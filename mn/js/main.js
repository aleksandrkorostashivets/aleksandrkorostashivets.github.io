...
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
  ...
  if (canvas) {
    ...
    const data = {
      labels: ['Magazine/E-Magazine Circulation', 'Websites', 'E-Newsletter', 'Email Direct Marketing', 'Social Media'],
      datasets: [{
        label: 'Audience',
        data: [53324, 1781819, 22512, 82512, 252238],
        backgroundColor: ['#4e79a7', '#f28e2b', '#e15759', '#76b7b2', '#2b635f'],
        borderWidth: 1,
        hoverOffset: 10
      }]
    };
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const navItems = nav ? nav.querySelectorAll('a') : null;
  ...
  document.onreadystatechange = function () {
    ...
    if (document.readyState !== "complete") {
      ...
      container.classList.add('site-container--hidden');
    } else {
      loader.style.display = 'none';
      container.classList.remove('site-container--hidden');
    }
  };
    ...
    tabComponents.forEach(tabComponent => {
      ...
      buttons.forEach(button => {
        button.addEventListener('click', () => {
          ...
          const target = tabComponent.querySelector(`.tab-component__content[data-content="${tab}"]`);
          if (target) {
  ...
  __webpack_require__.r(__webpack_exports__);
  am5.ready(function () {
    const container = document.getElementById("websiteMap");
    if (!container) return;
    var data = [{
      id: "NA",
      name: "North America",
