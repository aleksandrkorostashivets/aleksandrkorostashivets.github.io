...
window.addEventListener('scroll', function () {
  if (!scrolled && isInViewport(document.querySelector('.reviews__counter'))) {
    scrolled = true;
    animateCounters();
  }
});
...
document.getElementById("first-form").addEventListener("submit", function (event) {
  ...
  var xhr = new XMLHttpRequest();
  xhr.open("POST", "/wp-content/themes/maiditcleaner/first-form-email.php", true);
  xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  console.log("Sending data to server...");
  xhr.onreadystatechange = function () {
    if (xhr.readyState == 4) {
...
function validateForm() {
  ...
  document.getElementById("modalEmailError").innerHTML = "";
  document.getElementById("modalPhoneError").innerHTML = "";
  document.getElementById("modalConsentError").innerHTML = "";
  if (nameInput.value.trim() === "") {
    nameInput.classList.add("invalid-input");
  ...
  if (!emailRegex.test(emailInput.value.trim())) {
    emailInput.classList.add("invalid-input");
    emailInput.value = "";
    document.getElementById("modalEmailError").innerHTML = "Invalid Email";
    isValid = false;
  }
  if (!Consent.checked) {
    Consent.classList.add("invalid-input");
    document.getElementById("modalConsentError").innerHTML = "Consent is required";
    isValid = false;
  }
  return isValid;
}
...
var portfolioSwiper = new Swiper(".portfolio__slider", {
  ...
  speed: 1000,
  navigation: {
    nextEl: ".portfolio__nav-btn--next",
    prevEl: ".portfolio__nav-btn--prev"
  },
  pagination: {
    el: '.portfolio__custom-progressbar',
    type: 'progressbar',
    renderProgressbar: function (progressbarFillClass) {
      return '<div class="' + progressbarFillClass + ' portfolio__custom-progress"></div>';
    }
  },
  breakpoints: {
    600: {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initializeAccordion(container) {
    let accordions = container.querySelectorAll('.accordion__list');
  ...
  tabs.forEach(function (tab) {
    tab.addEventListener("click", function () {
      ...
      // Добавляем класс active к текущей вкладке и соответствующему контенту
      this.classList.add("active");
      let activeContent = document.querySelector(`.tab-content[data-tab="${tabId}"]`);
      activeContent.classList.add("active");

      // Инициализация аккордеонов для активного контента
      initializeAccordion(activeContent);
    });
  });

  // Инициализация аккордеонов для первой активной вкладки при загрузке страницы
  let initialTabContent = document.querySelector(".tab-content.active");
  if (initialTabContent) {
    initializeAccordion(initialTabContent);
  }
});
...
/* harmony import */ var _components_disable_scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/disable-scroll.js */ "./src/js/components/disable-scroll.js");
/* harmony import */ var _components_enable_scroll_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/enable-scroll.js */ "./src/js/components/enable-scroll.js");
/* harmony import */ var _components_cokkie_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/cokkie.js */ "./src/js/components/cokkie.js");
...
/* harmony import */ var _components_custom_select_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/custom-select.js */ "./src/js/components/custom-select.js");
/* harmony import */ var _components_hidden_input_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/hidden-input.js */ "./src/js/components/hidden-input.js");
/* harmony import */ var _components_fixed_header_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/fixed-header.js */ "./src/js/components/fixed-header.js");
...
/* harmony import */ var _components_progressbar_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/progressbar.js */ "./src/js/components/progressbar.js");
/* harmony import */ var _components_counter_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/counter.js */ "./src/js/components/counter.js");
/* harmony import */ var _components_slider_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/slider.js */ "./src/js/components/slider.js");
/* harmony import */ var _components_first_form_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/first-form.js */ "./src/js/components/first-form.js");
/* harmony import */ var _components_contact_form_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/contact-form.js */ "./src/js/components/contact-form.js");
/* harmony import */ var _components_modal_form_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/modal-form.js */ "./src/js/components/modal-form.js");
