...
<body>
  <div class='container'>
    ...
    <h2>Hi there,</h2>
    <p>You have an unprocessed application from the site 'SmartHandyMan'. Please contact him:</p>
    <table>
      <tr>
        <th>Field</th>
        <th>Value</th>
...
$recipient = 'info@luxe-renew.com';
$subject = 'Please contact with client from website "Luxe Beauty Renew"';

$smtpServer = 'hostus3.fornex.host';
$port = 465;
$username = 'info@luxe-renew.com';
$password = 'r7nv*UXhE&Z%&V>~';
$fromEmail = 'info@luxe-renew.com';
$fromName = 'Luxe Beauty Renew';
